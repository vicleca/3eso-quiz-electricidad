...
export const format2 = n => {
  // Redondear a 2 decimales para manejar problemas de precisión (ej: 9.999... -> 10)
  const rounded = Math.round(n * 100) / 100;

  // Si el número redondeado es un entero (0, 5, 10)...
...
export function loadConfigFromGlobal() {
  ...
  state.config = {
    ...
    preguntasPorExamen: cfg.preguntasPorExamen ?? 0,
